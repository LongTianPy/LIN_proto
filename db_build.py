...
def build_db():
	...
	c.execute('CREATE TABLE User (User_ID int NOT NULL AUTO_INCREMENT,FirststName varchar(255) NOT NULL,LastName varchar(255) NOT NULL,Institute varchar(255) NOT NULL,RegistrationDate text NOT NULL,Username varchar(255) NOT NULL,Password text NOT NULL,Email text NOT NULL,PRIMARY KEY (User_ID))')

...
def write_result_page(new_Genome_ID, new_LIN_object, new_LIN, db_cursor,User_ID,Interest_ID):
    ...
    f.write("<tr id='1' class='table-active record'><td style='padding-left: 10px'><input type='checkbox' id='row_checkbox[{0}]' class='row_checkbox' name='row_checkbox[{0}]'"
            "value='{0}'></td>"
    ...
    if related_hits:
        ...
        for i in range(len(df["Genus"])-2):
            real_i = i+2
            f.write(
                "<tr id='{0}' class='table-active record'><td style='padding-left: 10px'><input type='checkbox' id='row_checkbox[{0}]' class='row_checkbox' name='row_checkbox["
                "{0}]'"
                "value='{0}'></td>"
                "<td style='padding-left: 1px; width: 100px; overflow-x: auto;'>{1}</td>"
                "<td style='padding-left: 1px; width: 80px; overflow-x: auto;'>{2}</td>"
